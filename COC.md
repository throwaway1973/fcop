...
* **Assume the Best**. Assume the best intention when others communicate with you. If you don’t understand what someone meant, or have questions about it, ask them directly rather than speculating or spreading rumors. If someone appears to be communicating judgmentally ("COBOL sucks"), assume they did so only as a shorthand way of speaking, and ask them to clarify what objective metrics and subjective goals they are assuming ("It takes more lines of COBOL than lines of Haskell to accomplish the same task").
